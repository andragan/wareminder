...
export async function syncSubscriptionFromBackend(userId) {
    try {
        ...
        // Fetch and cache subscription using shared helper
        await fetchAndCacheSubscription(token);
        console.info("Subscription synced from backend");
        return true;
    } catch (error) {
...
export async function silentRefreshSubscription() {
    try {
        ...
        console.info(
            "Subscription silently refreshed from backend",
            subscription,
        );
        return {
            outcome: "refreshed",
...
export async function interactiveAuthRecovery() {
    try {
        ...
        console.info(
            "Subscription recovered after interactive auth",
            subscription,
        );
        return {
            outcome: "recovered",
